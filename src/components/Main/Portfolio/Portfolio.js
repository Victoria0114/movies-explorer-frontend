...
import { sampleWorkOne, sampleWorkThree, sampleWorkTwo } from "../../../utils/constants.js";
  ...
  return (
    <section id="portfolio" className="portfolio">
      ...
      <div className="portfolio__apps-container">
        {getSampleMarkup("Статичный сайт")}
        {getSampleMarkup("Адаптивный сайт")}
        {getSampleMarkup("Одностраничное приложение")}
      </div>
    </section>
  );
}